...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ImageUploader_t, stringdata) + ofs \
...
static const uint qt_meta_data_ImageUploader[] = {
...
const QMetaObject ImageUploader::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ImageUploader.data,
      qt_meta_data_ImageUploader,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ImageUploader.stringdata))
        return static_cast<void*>(const_cast< ImageUploader*>(this));

...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_SerialComm_t, stringdata) + ofs \
...
QT_MOC_LITERAL(6, 50, 6)
    ...
    "SerialComm\0lineReceived\0\0line\0"
    "errorOccurred\0error\0onPoll"
};
...
void SerialComm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->lineReceived((*reinterpret_cast< const QByteArray(*)>(_a[1]))); break;
        case 1: _t->errorOccurred((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 2: _t->onPoll(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SerialComm::lineReceived)) {
                *result = 0;
            }
        }
        {
            typedef void (SerialComm::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SerialComm::errorOccurred)) {
                *result = 1;
            }
        }
    }
...
// SIGNAL 0
void SerialComm::lineReceived(const QByteArray & _t1)
{

...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_visualizer_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 31, 21)
    ...
    "visualizer\0returnToMainWindow\0\0"
...
void visualizer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (visualizer::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&visualizer::returnToMainWindow)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject visualizer::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_visualizer.data,
      qt_meta_data_visualizer,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_visualizer.stringdata))
...
// SIGNAL 0
void visualizer::returnToMainWindow()
{
